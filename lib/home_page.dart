...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final itemList = inputProvider.itemList.where((item) {
      if (inputProvider.selectedOption == 'Checked') {
        return item.isChecked;
      } else if (inputProvider.selectedOption == 'Unchecked') {
        return !item.isChecked;
      }
      return true;
    }).toList();
                      ...
                      return ExpansionPanel(
                        headerBuilder: (BuildContext context, bool isExpanded) {
                          return Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: const Color.fromRGBO(244, 130, 65, 1),
                              ),
